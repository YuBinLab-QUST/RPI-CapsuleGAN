# -*- coding: utf-8 -*-
"""
Created on Wed Nov 10 15:00:32 2021
...
for train, test in skf.split(X,y): 
    ...
    cv_clf =get_GRU_model(input_dim,out_dim)
...
data_csv_zhibiao.to_csv('zhibiao_GRU.csv')
yscore_sum.to_csv('yscore_GRU.csv')
ytest_sum.to_csv('ytest_GRU.csv')
