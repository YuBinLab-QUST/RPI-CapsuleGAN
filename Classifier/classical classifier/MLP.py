...
cv_clf = MLPClassifier(solver='lbfgs', alpha=1e-5,hidden_layer_sizes=(1000, 100))
...
data_csv_zhibiao.to_csv('zhibiao_MLP.csv')
yscore_sum.to_csv('yscore_MLP.csv')
ytest_sum.to_csv('ytest_MLP.csv')
